function openLib(){
	...
	var innerHtml='<div>'
			+'<input type="text"/><a style="float:none;margin-left: 10px;" href="javascript:;">搜索</a><img src="img/icons.png" />'
	...
	hw.onclick=function(){searchSure.onclick({___in___:"doc"})};
	hp.onclick=function(){searchSure.onclick({___in___:"ppt"})};
	he.onclick=function(){searchSure.onclick({___in___:"xls"})};
}
